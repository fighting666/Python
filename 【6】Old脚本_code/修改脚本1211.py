...
execSQL0 = "SELECT iuser_uid,SUBSTR(iuser_uid,-1) FROM itd_plat WHERE plat IN('dbdc417fec38444aea7cf3944db6e081') AND FROM_UNIXTIME(addtime)>='2017-11-01 00:00:00';"
...
for userid1 in userid:
    ...
    for info in info1:
        ...
        # 104投资、507股权投资、202自动投资、20052抢现金券、204自动投资不用红包资金业务
        elif (info[3] == 104 or info[3] == 557 or info[3] == 202 or info[3] == 20052 or info[3] == 204):
